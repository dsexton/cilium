...
Setup a Kubernetes on AWS. You can use any method you prefer, for the simplicity
of this tutorial, we are going to use `eksctl
<https://github.com/weaveworks/eksctl>`_. For more details on how to set up ans
